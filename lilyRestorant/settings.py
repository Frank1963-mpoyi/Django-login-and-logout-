"""
Django settings for lilyRestorant project.
...
SECRET_KEY = '7(mxdd_ah*r3i5!hk4lil#ppeekq&p2wng0%g+26%l$d5$dw61'
...
ROOT_URLCONF = 'lilyRestorant.urls'
...
WSGI_APPLICATION = 'lilyRestorant.wsgi.application'
